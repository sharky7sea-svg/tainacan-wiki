...
TainacanはどのWordPressテーマでも動作します。ただし、そのすべての機能を最大限に活用するには、Tainacanをサポートするテーマを使用してください。
...
現在取り組んでいる最新バージョンを試したい場合は、これらの開発版をダウンロードできます。

これらは開発版であり、コードに追加した最新の内容で更新されていることに注意してください。いずれも本番環境での使用を想定した安定版ではありません。バグや未完成の機能が含まれている可能性があります。それでは、リンクを示します。

* [Tainacanプラグイン開発版](https://tainacan.org/nightly-builds/tainacan-nightly.zip)
* [Tainacanテーマ開発版](https://tainacan.org/nightly-builds/tainacan-interface-nightly.zip)
